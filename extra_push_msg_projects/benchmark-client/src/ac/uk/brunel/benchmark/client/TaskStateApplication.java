...
public class TaskStateApplication extends Application {
    ...
    public void onCreate() {
        ...
        options.developmentAppKey = "zjBnRrOJTli38yggCggWTQ";
        options.developmentAppSecret = "GdEohIZlSUSJd-T2rK91cA";
        options.productionAppKey = "zjBnRrOJTli38yggCggWTQ";
        options.productionAppSecret = "GdEohIZlSUSJd-T2rK91cA";
